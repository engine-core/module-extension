...
$column = [
    ...
    [
        'label'  => Yii::t('ec/modules/extension', 'Route'),
        'format' => 'raw',
        'value'  => function ($infoInstance) {
            /** @var ExtensionInfo|ControllerInfo $infoInstance */
            $route = $infoInstance->getModuleId()
                ? '/' . $infoInstance->getModuleId() . '/' . $infoInstance->getId()
                : '/' . $infoInstance->getId();
